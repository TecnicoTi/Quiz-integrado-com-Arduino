        ...
        return new Promise(function (resolve, reject) {
            ...
            switch (innerParams.input) {
                ...
                case 'radio':
                {
                    ...
                    populateInputOptions = function populateInputOptions(inputOptions) {
                        inputOptions.forEach(function (inputOption) {
                            var idRandom = "radio-" + random(10);
                            var radioValue = inputOption[0];
                            var radioLabel = inputOption[1];
                            var radioInput = document.createElement('input');
                            var radioLabelElement = document.createElement('li');
                            radioInput.type = 'radio';
                            radioInput.name = swalClasses.radio;
                            radioInput.value = radioValue;
                            radioInput.id = idRandom;
                            ...
                            label.setAttribute('for', idRandom);
                            radioLabelElement.appendChild(radioInput);
                            radioLabelElement.appendChild(label);
                            radioLabelElement.appendChild(check);
                            ul.appendChild(radioLabelElement);
                        });
                        radio.appendChild(ul);
                        show(radio);
